...
PACKAGE = ROOT / "profiles/invinoveritas-signed-verdict-v0"
...
UPSTREAM_PATH = PACKAGE / "upstream/verdict_proof.json"

PROFILE_ID = "rvr-invinoveritas-signed-verdict-v0"
PROPOSITION = "rvr.invinoveritas.v0.signed_verdict_artifact_bindings"
ISSUER_PUBKEY = "6786e18a864893a900bd9858e650f67ccc3513f248fed374b591e2ff6922fbb7"
UPSTREAM_SHA256 = "d2817c525e1cfd2a7838d9e3b6b203dd44cb18daa21361d0620f45235da0b98b"
UPSTREAM_REVISION = "25a239afabc1bb5f066e0738e6a1a7a75535f0e5"
UPSTREAM_GIT_BLOB = "e400c8f9ec188115d7710298cc22c59e7de5ab65"
UPSTREAM_REPOSITORY = "babyblueviper1/invinoveritas"
UPSTREAM_SOURCE_PATH = "examples/rvr-verdict-worked-example/verdict_proof.json"
UPSTREAM_BYTE_LENGTH = "12332"
...
PACKAGE_MEMBERS = (
    ...
    "profiles/invinoveritas-signed-verdict-v0/README.md",
    "profiles/invinoveritas-signed-verdict-v0/SPEC.md",
    "profiles/invinoveritas-signed-verdict-v0/adapter.py",
    "profiles/invinoveritas-signed-verdict-v0/expected.json",
    "profiles/invinoveritas-signed-verdict-v0/profile.schema.json",
    "profiles/invinoveritas-signed-verdict-v0/rvr.schema.json",
    "profiles/invinoveritas-signed-verdict-v0/test_profile.py",
    "profiles/invinoveritas-signed-verdict-v0/upstream/verdict_proof.json",
    "profiles/invinoveritas-signed-verdict-v0/vectors.json",
    "profiles/invinoveritas-signed-verdict-v0/verification-profile.json",
)
...
def audit_profile(overrides: dict[str, bytes] | None = None) -> tuple[dict[str, Any], str, dict[str, Any], dict[str, bytes]]:
    ...
    constraints = parse_json(
        pinned["invinoveritas-signed-verdict-profile-schema"],
...
def unavailable_member(identifier: str) -> dict[str, str]:
    return {
        "id": identifier,
        "status": "UNAVAILABLE",
        "reasonCode": "rvr.invinoveritas.v0.evidence_unavailable",
    }
...
def source_inputs(source: dict[str, Any]) -> tuple[dict[str, Any], bytes, dict[str, Any], dict[str, Any]]:
    ...
    claim = {
        "schema": "rvr.claim.invinoveritas-signed-verdict.v0",
...
def result(outcome: str, reason_code: str, evaluation: dict[str, Any]) -> dict[str, Any]:
    return {
        "schema": "rvr.canonical-result.invinoveritas-signed-verdict.v0",
        "proposition": PROPOSITION,
        "outcome": outcome,
...
def blank_evaluation(claim: dict[str, Any]) -> dict[str, Any]:
    return {
        "procedure": "INVINO_SIGNED_VERDICT_BINDING_VERIFY_V0",
...
def evaluate(
    ...
    unavailable_reasons = (
        ("artifact-bytes", "rvr.invinoveritas.v0.required_artifact_unavailable"),
        ("policy-preimage", "rvr.invinoveritas.v0.required_policy_preimage_unavailable"),
        ("signed-event", "rvr.invinoveritas.v0.required_signed_event_unavailable"),
    )
    ...
    try:
        ...
        return result("REFUTED", "rvr.invinoveritas.v0.policy_commitment_mismatch", evaluation)
    ...
    try:
        ...
        return result("REFUTED", "rvr.invinoveritas.v0.signed_event_invalid", evaluation)
    ...
    try:
        ...
        return result("REFUTED", "rvr.invinoveritas.v0.event_content_invalid", evaluation)
    ...
    checks = (
        (evaluation["artifactDigest"] == claim["artifactHash"], "rvr.invinoveritas.v0.artifact_digest_mismatch"),
        (evaluation["policyDigest"] == claim["policyCommitment"], "rvr.invinoveritas.v0.policy_commitment_mismatch"),
        (event["pubkey"] == ISSUER_PUBKEY and event["pubkey"] == claim["issuerPubkey"], "rvr.invinoveritas.v0.issuer_pubkey_mismatch"),
        (evaluation["eventDigest"] == event["id"] and event["id"] == claim["eventId"], "rvr.invinoveritas.v0.event_id_mismatch"),
        (signature_valid, "rvr.invinoveritas.v0.signature_invalid"),
        (content.get("artifact_hash") == claim["artifactHash"], "rvr.invinoveritas.v0.event_artifact_binding_mismatch"),
        (content.get("policy_commitment") == "sha256:" + claim["policyCommitment"], "rvr.invinoveritas.v0.event_policy_binding_mismatch"),
        (content.get("decision_ref") == "sha256:" + claim["decisionRef"], "rvr.invinoveritas.v0.event_decision_binding_mismatch"),
        (
            ...
            "rvr.invinoveritas.v0.event_policy_binding_mismatch",
        ),
        (evaluation["decisionDigest"] == claim["decisionRef"], "rvr.invinoveritas.v0.decision_ref_mismatch"),
    )
    for passed, reason_code in checks:
        if not passed:
            return result("REFUTED", reason_code, evaluation)
    return result("VERIFIED", "rvr.invinoveritas.v0.signed_verdict_bindings_verified", evaluation)
...
def run_gate() -> dict[str, Any]:
    ...
    vectors = parse_json(pinned["invinoveritas-verification-vectors"], str(VECTORS_PATH))
    expected = parse_json(pinned["invinoveritas-expected-results"], str(EXPECTED_PATH))
    upstream_bytes = pinned["invinoveritas-upstream-verdict-proof"]
    expected_source = {
    ...
    tampered_constraints = expect_rejection(
        lambda: audit_profile({"invinoveritas-signed-verdict-profile-schema": b"{not-valid-json"}),
        "rvr.gate.identity_mismatch",
    )
    ...
    return {
        "gate": "RVR_INVINO_SIGNED_VERDICT_PASS",
